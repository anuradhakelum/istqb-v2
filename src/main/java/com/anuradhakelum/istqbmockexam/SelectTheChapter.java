...
public class SelectTheChapter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_the_chapter);
        ...
        MobileAds.initialize(getApplicationContext(), SelectTheChapter01.CA_APP_PUB);
